...
2. **VLA Portability & Safety:** In ISO C11, Variable Length Arrays were made optional (`__STDC_NO_VLA__`) and are banned in the Linux Kernel due to stack exhaustion risks.
