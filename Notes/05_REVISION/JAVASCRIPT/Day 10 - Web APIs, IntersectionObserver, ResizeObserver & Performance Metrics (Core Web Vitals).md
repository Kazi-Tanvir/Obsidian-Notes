...
| **ResizeObserver** | box: 'content-box' | 'border-box'   Resp | nsive component layout, canvas/chart auto-resizing |
| **PerformanceObserver** | type: 'largest-contentful-paint'       M | asures page load speed candidate |
| **PerformanceObserver** | type: 'layout-shift'                   T | acks unexpected layout shifts (CLS) |
| **PerformanceObserver** | type: 'event'                          T | acks user input latency (INP) |
