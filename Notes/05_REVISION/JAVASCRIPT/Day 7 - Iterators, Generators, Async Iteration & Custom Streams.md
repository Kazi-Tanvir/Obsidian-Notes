...
| --- | --- | --- |
| **Iterable Protocol** | [Symbol.iterator]()                  R | turns iterator with .next() method |
| **Async Iterable** | [Symbol.asyncIterator]()             R | turns iterator with async next() method |
| **Generator Declaration** | function* name() {} | reates GeneratorObject instance |
| **Yield Value** | yield value; | Pauses function and yields value |
| **Yield Delegation** | yield* iterable; | elegates control to another iterable |
