...
- **Mapped Types with Key Remapping**: \[K in keyof T as \\prefix\_\${string & K}\`\]: T\[K\]\`.
...
\[K in keyof T as K extends \"\_\_proto\_\_\" \| \"prototype\" \| \"constructor\" ? never : K\]: T\[K\] extends object ? SafeClone\<T\[K\]\> : T\[K\];
...
if (key !== \"\_\_proto\_\_\" && key !== \"constructor\" && key !== \"prototype\") {
...
const tainted = JSON.parse(\'{\"validKey\": \"data\", \"\_\_proto\_\_\": {\"polluted\": true}}\');
